...
export function PublicLandingPage({ onOpenMap, onLogin, onSignUp }) {
    ...
    <main className="public-landing">
      <header className="public-nav">
        <div className="public-nav-brand">
          <img src="/smartlink.png" alt="SmartLink" />
          <span>SmartLink</span>
        </div>
      ...
      <div className={`public-nav-mobile-panel ${isNavOpen ? "is-open" : ""}`}>
        <a href="#fuel-map" onClick={() => setIsNavOpen(false)}>
          Fuel Map
        </a>
        <a href="#how-it-works" onClick={() => setIsNavOpen(false)}>
          How it Works
        </a>
        <a href="#stations" onClick={() => setIsNavOpen(false)}>
          Stations
        </a>
        <a href="#benefits" onClick={() => setIsNavOpen(false)}>
          Benefits
        </a>
        <a href="#download" onClick={() => setIsNavOpen(false)}>
          Download
        </a>
      ...
      <section id="fuel-map" className="public-hero">
        <div className="public-hero-copy">
          ...
          <p>
            SmartLink shows nearby stations, fuel availability, and queue
            movement in one place. Open the map to choose a station and
            continue.
          </p>
        ...
        <article
          className="public-map-preview"
          aria-label="Fuel availability preview map"
        >
          ...
          <div className="public-map-legend">
            <span>
              <em className="tone-safe" /> High
            </span>
            <span>
              <em className="tone-warning" /> Medium
            </span>
            <span>
              <em className="tone-danger" /> Low
            </span>
          </div>
        </article>
      </section>
      ...
      <section id="how-it-works" className="public-section">
        ...
        <div className="public-steps">
          <article>
            ...
            <h3>Open the map</h3>
            <p>
              See stations with current fuel availability and activity status.
            </p>
          </article>
          <article>
            <strong>2</strong>
            ...
            <p>
              Review queue conditions, fuel type options, and station details.
            </p>
          </article>
          <article>
            <strong>3</strong>
            ...
            return (
              <article key={station.id} className="public-station-card">
                ...
                <div className="public-station-meta">
                  <span>
                    {Number(station.distanceKm || 0).toFixed(1)} km away
                  </span>
                  <span className={`status-${fuelTone.tone}`}>
                    {fuelTone.label} fuel
                  </span>
                </div>
              </article>
      ...
      <section id="download" className="public-section public-download">
        <div>
          ...
          <p>
            Install SmartLink on your phone for realtime queue tracking and
            reservations.
          </p>
        </div>
      ...
      <section className="public-section public-auth-cta">
        ...
        <p>
          Create your SmartLink account or login to access the full station map
          and queue tools.
        </p>
        <div className="public-hero-actions">
          <button
