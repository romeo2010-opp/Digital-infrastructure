          ...
          >
            <div className="landing-language-modal-top">
              <div className="landing-language-modal-brand">
                <img src="/smartlink.png" alt="" />
                <span>SmartLink</span>
              </div>
              <span className="landing-language-modal-tag">
                {t("landing.modal.tag")}
              </span>
            </div>
            ...
            <div className="landing-language-modal-copy">
              ...
              <p id="landing-language-description">
                {t("landing.modal.description")}
              </p>
            </div>

            <div
              className="landing-language-actions"
              role="group"
            ...
            <p className="landing-language-modal-note">
              {t("landing.modal.note")}
            </p>
          </_motion.div>
        </_motion.div>
      ) : null}
