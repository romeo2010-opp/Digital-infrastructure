  ...
  for (const assignment of alternative.assignments || []) {
    ...
    assignmentPayloads.push({
      ...
      payload: {
        ...
        cycle_week: Number(assignment.cycleWeek || assignment.cycle_week || 1),
  ...
  for (const { assignment, payload } of assignmentPayloads) {
    ...
    await connection.query(
      `INSERT INTO timetable_entries (
        timetable_version_id, cycle_week, cycle_day_id, slot_start_id, slot_end_id, entry_type, subject_id, class_id,
